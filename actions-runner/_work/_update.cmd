...
set rootfolder=C:\Users\Usuario\Desktop\papelaria-crud-tcc\actions-runner
set existrunnerversion=2.329.0
set downloadrunnerversion=2.330.0
set logfile=C:\Users\Usuario\Desktop\papelaria-crud-tcc\actions-runner\_diag\SelfUpdate-20260111-232747.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "C:\Users\Usuario\Desktop\papelaria-crud-tcc\actions-runner\run.cmd"
) else (
  endlocal
)
